...
with part:
    add(body2.part,   mode=Mode.ADD)
    add(body2_right,  mode=Mode.ADD)
    add(body2_back_l, mode=Mode.ADD)
    add(body2_back_r, mode=Mode.ADD)
...
# ---------------------------------------------------------------------------
# STEP + STL Export — popup dialog asks for save location every run
# ---------------------------------------------------------------------------
