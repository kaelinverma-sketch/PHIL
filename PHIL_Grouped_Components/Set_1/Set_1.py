...
x_shift = 140 - 129.5312
raw_new_pts = [
    (129.5312, 0.0), (491.1328, 0.0), (494.5703, -3.4375), (498.2422, -6.6406),
    (502.1094, -9.5898), (506.1719, -12.2852), (510.3906, -14.6875),
    (514.7656, -16.8164), (519.2969, -18.6523), (523.9062, -20.1758),
    (528.5938, -21.3867), (533.3984, -22.2852), (538.2422, -22.8711),
    (543.0859, -23.125), (547.9688, -23.0664), (552.8125, -22.6758),
    (557.6172, -21.9531), (562.3828, -20.9375), (567.0703, -19.5898),
    (571.6406, -17.9297), (576.0938, -15.9766), (580.3906, -13.7305),
    (584.5703, -11.2109), (588.5547, -8.418), (592.3438, -5.3516),
    (592.5781, -2.1094), (550.8594, -2.1094), (546.9531, -2.4414),
    (543.0469, -2.4805), (539.1016, -2.207), (535.2344, -1.6602),
    (531.4062, -0.8203), (527.6562, 0.293), (523.9844, 1.6992),
    (520.4297, 3.3594), (517.0312, 5.293), (132.7344, 100.0),
    (129.5312, 100.0),
]
...
body3_pts = [
    (132.7344, 100.0), (407.9297, 100.0), (410.9766, 104.9609), (414.2969, 109.7266),
    (417.9297, 114.2773), (421.7969, 118.6328), (425.8984, 122.7539),
    (430.2344, 126.6211), (434.8047, 130.2148), (439.5703, 133.5547),
    (444.5312, 136.6016), (449.6484, 139.375), (454.9219, 141.8359),
    (460.3125, 143.9844), (465.8594, 145.8008), (471.4844, 147.3047),
    (477.1484, 148.4961), (482.9297, 149.3359), (488.7109, 149.8438),
    (494.5312, 150.0), (500.3516, 149.8438), (506.1328, 149.3359),
    (511.875, 148.4961), (517.5781, 147.3047), (523.2031, 145.8008),
    (528.75, 143.9844), (534.1406, 141.8359), (539.4141, 139.375),
    (544.5312, 136.6016), (549.4922, 133.5547), (554.2578, 130.2148),
    (558.7891, 126.6211), (563.1641, 122.7539), (567.2656, 118.6328),
    (571.1328, 114.2773), (574.7266, 109.7266), (578.0859, 104.9609),
    (581.1328, 100.0), (583.9062, 94.8828), (586.3672, 89.6094),
    (588.5156, 84.2188), (590.3125, 78.6914), (591.8359, 73.0664),
    (593.0078, 67.3633), (593.8672, 61.6211), (594.375, 55.8203),
    (594.5312, 50.0), (594.4141, 36.9727), (594.0234, 23.9258),
    (593.4375, 10.8984), (592.5781, -2.1094), (550.8594, -2.1094),
    (546.9531, -2.4414), (543.0469, -2.4805), (539.1016, -2.207),
    (535.2344, -1.6602), (531.4062, -0.8203), (527.6562, 0.293),
    (523.9844, 1.6992), (520.4297, 3.3594), (517.0312, 5.293),
]
...
body4_pts = [
    (-10.4688, 117.832), (-10.4688, -17.8125), (-7.5781, -13.5352),
    (-4.8438, -9.1406), (-2.3047, -4.6094), (0.0, 0.0),
    (129.5312, 0.0), (129.5312, 100.0), (0.0, 100.0),
    (-2.3047, 104.6289), (-4.8438, 109.1602), (-7.5781, 113.5547),
]
body4_pts = [(x + 10.4688, y) for x, y in body4_pts]
...
hole_pts = [(x + 10.4688, y) for x, y in hole_pts]
...
t_pts = [
    (-25.0, 158.0), (4.0, 130.0), (-124.375, 2.832), (-113.75, -7.7734),
    (-142.0312, -36.0742), (-191.5625, 13.4375), (-163.2422, 41.7188),
    (-152.6562, 31.1133),
]
t_pts = [(x + 10.4688, y) for x, y in t_pts]
...
import math as _math5
_inner_all_c = inner2_all  # reuse same data for chamfer lofts
_outer_all_c = [
...
cut_raw = [
    (173.5938, 20.0), (173.5938, 82.4805), (185.3906, 82.4805),
    (185.3906, 33.2227), (273.5547, 33.2227), (273.5547, 20.0),
]
cut_pts = [(x + 10.4688, y) for x, y in cut_raw]
...
with BuildPart() as combined_all:
    ...
    extrude(amount=-500, mode=Mode.SUBTRACT)
    with BuildSketch(Plane.XY.offset(-7.5)):
        with BuildLine(): Polyline(*i2_h2_pts, close=True)
        make_face()
    extrude(amount=500, mode=Mode.SUBTRACT)
    with BuildSketch(Plane.XY.offset(-7.5)):
        with BuildLine(): Polyline(*i2_h2_pts, close=True)
    ...
    with BuildSketch(Plane.XY.offset(0)):
        with BuildLine(): Polyline(*h2_c1_pts, close=True)
        make_face()
    extrude(amount=-500, mode=Mode.SUBTRACT)
    with BuildSketch(Plane.XY.offset(0)):
        with BuildLine(): Polyline(*h2_c2_pts, close=True)
        make_face()
    extrude(amount=-500, mode=Mode.SUBTRACT)
    with BuildSketch(Plane.XY.offset(0)):
        with BuildLine(): Polyline(*h3_c1_pts, close=True)
        make_face()
    extrude(amount=50, mode=Mode.SUBTRACT)
    with BuildSketch(Plane.XY.offset(0)):
        with BuildLine(): Polyline(*h3_c2_pts, close=True)
        make_face()
    extrude(amount=50, mode=Mode.SUBTRACT)
    ...
    with BuildSketch(Plane.XY.offset(-35)):
        with BuildLine(): Polyline(*cut_pts, close=True)
        make_face()
    extrude(amount=50, mode=Mode.SUBTRACT)
...
_er_shape1_points = [
    (540813.2812, 233918.75),(540813.2812, 233783.1055),(540817.0703, 233778.1055),
    (540821.0938, 233773.3203),(540825.3906, 233768.75),(540829.9219, 233764.4336),
    (540834.6875, 233760.3516),(540839.6484, 233756.5234),(540844.8047, 233752.9883),
    (540850.1562, 233749.7266),(540855.6641, 233746.7383),(540861.3281, 233744.082),
    (540867.1094, 233741.6992),(540873.0078, 233739.6484),(540879.0234, 233737.9297),
    (540885.1562, 233736.5234),(540891.3281, 233735.4492),(540897.5391, 233734.6875),
    (540903.7891, 233734.2773),(540910.0391, 233734.2188),(540916.2891, 233734.4727),
    (540922.5391, 233735.0781),(540928.7109, 233735.9961),(540940.8984, 233738.8477),
    (540946.875, 233740.7617),(540952.7344, 233742.9883),(540958.4375, 233745.5273),
    (540964.0234, 233748.3594),(540969.4531, 233751.5039),(540979.7266, 233758.6133),
    (540989.2188, 233766.7969),(540993.6328, 233771.2695),(540997.7734, 233775.957),
    (540871.7969, 233912.1289),(540870.0391, 233913.8281),(540868.0859, 233915.2539),
    (540865.8984, 233916.4062),(540863.6328, 233917.2461),(540861.25, 233917.7539),
    (540858.7891, 233917.9297),(540856.3672, 233917.7539),(540853.9844, 233917.2461),
    (540851.6797, 233916.4062),(540849.5312, 233915.2539),(540847.5391, 233913.8281),
    (540845.7812, 233912.1289),(540844.2969, 233910.2148),(540843.0859, 233908.0859),
    (540842.1484, 233905.8203),(540841.5625, 233903.457),(540841.3281, 233901.0352),
]

_er_hole2_points = [
    (540940.3906, 233799.5898),(540940.8203, 233797.1875),(540941.5625, 233794.8633),
    (540942.6562, 233792.6758),(540943.9844, 233790.6445),(540945.625, 233788.8477),
    (540947.5, 233787.2656),(540949.5703, 233785.9766),(540951.7969, 233784.9805),
    (540954.1406, 233784.3164),(540956.5625, 233783.9648),(540959.0234, 233783.9648),
    (540961.4453, 233784.3164),(540963.7891, 233784.9805),(540966.0156, 233785.9766),
    (540968.0859, 233787.2656),(540969.9609, 233788.8477),(540971.6016, 233790.6445),
    (540972.9297, 233792.6758),(540974.0234, 233794.8633),(540974.7656, 233797.1875),
    (540975.1953, 233799.5898),(540975.2734, 233802.0312),(540975.0391, 233804.4727),
    (540974.4531, 233806.8359),(540973.5156, 233809.1016),(540972.3047, 233811.2109),
    (540970.7812, 233813.1445),(540969.0234, 233814.8242),(540967.0703, 233816.2695),
    (540964.9219, 233817.4219),(540962.6172, 233818.2422),(540960.2344, 233818.75),
    (540957.8125, 233818.9258),(540955.3516, 233818.75),(540952.9688, 233818.2422),
    (540950.6641, 233817.4219),(540948.5156, 233816.2695),(540946.5625, 233814.8242),
    (540944.8047, 233813.1445),(540943.2812, 233811.2109),(540942.0703, 233809.1016),
    (540941.1328, 233806.8359),(540940.5469, 233804.4727),(540940.3125, 233802.0312),
]
...
_er_outer11a_points = _er_outer10a_points
_er_inner11a_points = [
...
_er_outer11b_points = _er_outer10b_points
_er_inner11b_points = [
...
_er_shape13_points = [
    (540282.4219, 233892.0312),(540286.7578, 233892.0312),(540285.3516, 233892.9688),
    (540283.9062, 233893.8672),(540282.4219, 233894.707),
]

_er_shape18_points = [
    (540808.2812, 233905.918),(540808.2812, 233798.1055),
    (540678.2812, 233798.1055),(540678.2812, 233905.918),
]

# Shared origin
_er_all_pts = _er_shape1_points + _er_shape2_points + _er_shape3_points + _er_shape4_cutter_points
...
with BuildSketch() as _er_sk1:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape1_points), close=True)
    make_face()
_er_extrude1 = extrude(_er_sk1.sketch, amount=100)

with BuildSketch() as _er_sk2:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape2_points), close=True)
    make_face()
...
with BuildSketch() as _er_sk3:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape3_points), close=True)
    make_face()
_er_extrude3 = extrude(_er_sk3.sketch, amount=100)

with BuildSketch() as _er_sk4:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape4_cutter_points), close=False)
    make_face()
_er_cutter = extrude(_er_sk4.sketch, amount=50)
_er_cutter = _er_cutter.translate(Vector(0, 0, 50))

with BuildSketch() as _er_sk5:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape5_points), close=True)
    make_face()
_er_extrude5 = extrude(_er_sk5.sketch, amount=30)

with BuildSketch() as _er_sk6:
    with BuildLine(): Polyline(*_er_to_vec(_er_outer_points), close=True)
    make_face()
    with BuildLine(): Polyline(*_er_to_vec(_er_inner_points), close=True)
...
with BuildSketch() as _er_sk7:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape7_points), close=True)
    make_face()
...
with BuildSketch() as _er_sk8:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape8_points), close=True)
    make_face()
...
with BuildSketch(Plane.XY.offset(-120)) as _er_sk9a:
    with BuildLine(): Polyline(*_er_to_vec(_er_hole1_points), close=True)
    make_face()
_er_hole1 = extrude(_er_sk9a.sketch, amount=240)

with BuildSketch(Plane.XY.offset(-120)) as _er_sk9b:
    with BuildLine(): Polyline(*_er_to_vec(_er_hole2_points), close=True)
    make_face()
_er_hole2 = extrude(_er_sk9b.sketch, amount=240)

with BuildSketch() as _er_sk10:
    with BuildLine(): Polyline(*_er_to_vec(_er_outer10a_points), close=True)
    make_face()
    with BuildLine(): Polyline(*_er_to_vec(_er_outer10b_points), close=True)
    make_face()
_er_extrude10 = extrude(_er_sk10.sketch, amount=50)

with BuildSketch(Plane.XY.offset(50)) as _er_sk11a_bot:
    with BuildLine(): Polyline(*_er_to_vec(_er_outer11a_points), close=True)
    make_face()
with BuildSketch(Plane.XY.offset(67.5)) as _er_sk11a_top:
    with BuildLine(): Polyline(*_er_to_vec(_er_inner11a_points), close=True)
    make_face()
_er_chamfer_a = loft([_er_sk11a_bot.sketch, _er_sk11a_top.sketch])

with BuildSketch(Plane.XY.offset(50)) as _er_sk11b_bot:
    with BuildLine(): Polyline(*_er_to_vec(_er_outer11b_points), close=True)
    make_face()
with BuildSketch(Plane.XY.offset(67.5)) as _er_sk11b_top:
    with BuildLine(): Polyline(*_er_to_vec(_er_inner11b_points), close=True)
    make_face()
...
with BuildSketch(Plane.XY.offset(-120)) as _er_sk12a:
    with BuildLine(): Polyline(*_er_to_vec(_er_hole12a_points), close=True)
    make_face()
_er_hole12a = extrude(_er_sk12a.sketch, amount=240)

with BuildSketch(Plane.XY.offset(-120)) as _er_sk12b:
    with BuildLine(): Polyline(*_er_to_vec(_er_hole12b_points), close=True)
    make_face()
_er_hole12b = extrude(_er_sk12b.sketch, amount=240)

with BuildSketch() as _er_sk13:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape13_points), close=True)
    make_face()
...
with BuildSketch() as _er_sk18:
    with BuildLine(): Polyline(*_er_to_vec(_er_shape18_points), close=True)
    make_face()
_er_extrude18 = extrude(_er_sk18.sketch, amount=57.5)

_er_result_main = (_er_extrude1 + _er_extrude2 + _er_extrude3
                   - _er_cutter - _er_extrude5 - _er_hollow_cylinder
                   - _er_extrude7 - _er_extrude8 - _er_hole1 - _er_hole2
                   - _er_extrude10 - _er_extrude11 - _er_hole12a - _er_hole12b
                   - _er_cutter13 - _er_extrude14 - _er_extrude15 - _er_extrude16 - _er_extrude17)
...
# ╔══════════════════════════════════════════════════════════════════════════════
# PART F — HANDS (Hand1, Hand2, Hand3)
# ╔══════════════════════════════════════════════════════════════════════════════
import math as _math
...
_slot_raw = [
    (541444.2188,234148.9648,50.0),(541449.8047,234148.6523,50.0),(541455.3516,234147.7148,50.0),
    (541460.7422,234146.1719,50.0),(541465.8984,234144.0234,50.0),(541470.8203,234141.3086,50.0),
    (541475.3906,234138.0664,50.0),(541479.5703,234134.3359,50.0),(541483.3203,234130.1562,50.0),
    (541486.5625,234125.5664,50.0),(541489.2578,234120.6641,50.0),(541491.4062,234115.4883,50.0),
    (541492.9688,234110.0977,50.0),(541493.9062,234104.5703,50.0),(541494.2188,234098.9648,50.0),
    (541493.8672,234093.2031,50.0),(541492.8906,234087.5,50.0),(541491.2109,234081.9531,50.0),
    (541488.9453,234076.6406,50.0),(541486.0547,234071.6211,50.0),(541482.6172,234066.9727,50.0),
    (541478.6719,234062.7344,50.0),(541474.2578,234059.0039,50.0),(541469.4531,234055.8008,50.0),
    (541464.2969,234053.1836,50.0),(541458.8672,234051.1719,50.0),(541453.2422,234049.7852,50.0),
    (541447.5,234049.082,50.0),(541441.7188,234049.043,50.0),(539989.2188,234048.9648,50.0),
    (539983.3984,234049.3164,50.0),(539977.6953,234050.3125,50.0),(539972.1094,234051.9922,50.0),
    (539966.7578,234054.2969,50.0),(539961.7578,234057.207,50.0),(539957.0703,234060.6641,50.0),
    (539952.8516,234064.668,50.0),(539949.1016,234069.1211,50.0),(539945.8984,234073.9648,50.0),
    (539943.3203,234079.1602,50.0),(539941.3281,234084.6289,50.0),(539939.9609,234090.293,50.0),
    (539939.2969,234096.0742,50.0),(539939.2969,234101.875,50.0),(539939.9609,234107.6562,50.0),
    (539941.3281,234113.3203,50.0),(539943.3203,234118.7695,50.0),(539945.8984,234123.9648,50.0),
    (539949.1016,234128.8281,50.0),(539952.8516,234133.2812,50.0),(539957.0703,234137.2656,50.0),
    (539961.7578,234140.7422,50.0),(539966.7578,234143.6523,50.0),(539972.1094,234145.957,50.0),
    (539977.6953,234147.6172,50.0),(539983.3984,234148.6328,50.0),(539989.2188,234148.9648,50.0),
]
_cut_raw = [
    (541494.2188,234098.9648,40.0),(541494.2188,234198.9648,40.0),(541493.9062,234204.7266,40.0),
    (541493.0078,234210.4102,40.0),(541491.5234,234215.9766,40.0),(541489.4531,234221.3477,40.0),
    (541486.8359,234226.4648,40.0),(541483.7109,234231.3086,40.0),(541480.0781,234235.7812,40.0),
    (541476.0156,234239.8438,40.0),(541471.5234,234243.4766,40.0),(541466.7188,234246.6016,40.0),
    (541466.7188,234238.3789,40.0),(541471.25,234234.7852,40.0),(541475.3516,234230.6836,40.0),
    (541478.8672,234226.0938,40.0),(541481.875,234221.1328,40.0),(541484.2188,234215.8398,40.0),
    (541485.9375,234210.3125,40.0),(541486.9531,234204.6094,40.0),(541487.2656,234198.8281,40.0),
